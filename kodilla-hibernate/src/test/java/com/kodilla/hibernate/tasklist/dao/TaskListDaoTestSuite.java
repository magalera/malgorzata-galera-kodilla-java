...
public class TaskListDaoTestSuite {
    ...
    public void testFindByListName() {
        //Given
        TaskList taskList = new TaskList("testFindByListName", DESCRIPTION);
        ...
        List<TaskList> taskLists = taskListDao.findByListName("testFindByListName");
        Assert.assertEquals(1, taskLists.size());
        Assert.assertEquals("testFindByListName", taskLists.get(0).getListName());
    ...
    public void testTaskListDaoSaveWithTasks() {
        ...
        TaskList taskList = new TaskList("testTaskListDaoSaveWithTasks", "ToDo tasks");
    ...
    public void testNamedQueries() {
        ...
        TaskList taskList = new TaskList("testNamedQueries", "ToDo tasks");
